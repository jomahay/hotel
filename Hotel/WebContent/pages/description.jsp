...
<html lang="en">
  <head>
	...
	que nous proposons dans notre hotel de Nosy be.
	...
	des lieux de sejour uniques, Chambres jonatanaHotel d'hotel speciales">
  ...
  <div id="blog" class="site-section">
    <div class="container">
            ...
            <div class="row">
              ...
              <div class="col-md-8">
                <h1 class="mb-3">${listechambreview.nomchambre }</h1>

                <p><img src="<c:url value="/assets/images/${listechambreview.imagechambre}"/>" alt="" width="600" height="80" class="img-fluid"></p>
				<h2>Type du chambre</h2>
				<p>${listechambreview.nomtype}</p>
				<h2 >Prix</h2>
                <p>${listechambreview.prix} Ar</p>
				<h2 >Personnes</h2>
                <p>cette chambre peut heberger ${listechambreview.nombrepersonne}  personnes.</p>
				<h2 >Description de la chambre</h2>
				<p>${listechambreview.description}</p>
				<h2>Equipements</h2>
				<c:forEach items="${listechambrecv}" var="item">
