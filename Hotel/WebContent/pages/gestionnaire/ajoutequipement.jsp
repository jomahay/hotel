	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Ajout equipement</li>
			</ol>
		</div><!--/.row-->
		
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Ajout equipement</h1>
			</div>
		</div><!--/.row-->
		...
		<div class="row">
			<div class="col-lg-12">
				...
				<div class="panel panel-default">
					<div class="panel-heading">Formulaire d ajout equipement</div>
					<div class="panel-body">
						
						<div class="col-md-6">
							<form action="${pageContext.request.contextPath }/insererEquipement" method="post"  >
								
								<div class="form-group">
									<label>nom equipement</label>
									<input name="nomequipement" type="text" class="form-control"  placeholder="nom equipement">
								</div>
								<input type="submit" class="btn btn-success "  value="inserer equipement" />
