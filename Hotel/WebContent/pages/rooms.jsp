...
<html lang="en">
  <head>
    <title>Liste des chambres dans jonatanaHotel</title>
    <meta charset="utf-8">
          ...
          <div class="col-lg-4 mb-5">
            <div class="block-34">
              ...
              <div class="text">
                ...
                <center><p><a href="${pageContext.request.contextPath }/chambre/${item.nomchambre}" class="btn btn-danger py-3 px-5">voir detail</a></p></center>
              </div>
            </div>
          </div>
			 </c:forEach>
